...
#create link
$ns duplex-link $n0 $n4 20Mb 3ms DropTail
$ns duplex-link $n1 $n4 20Mb 3ms DropTail
$ns duplex-link $n2 $n4 20Mb 3ms DropTail
$ns duplex-link $n3 $n4 120Mb 3ms DropTail
#$ns duplex-link $n4 $n5 40Mb 3ms HRCC
#$ns duplex-link $n4 $n5 40Mb 3ms AFQ10
#$ns duplex-link $n4 $n5 40Mb 3ms AFQ100
#$ns duplex-link $n4 $n5 40Mb 3ms AFQ1000
#$ns duplex-link $n4 $n5 40Mb 3ms DropTail
$ns duplex-link $n4 $n5 40Mb 3ms HRCCPL
...
#event
$ns at .010 "$ftp0 start"
$ns at .010 "$ftp1 start"
$ns at .010 "$ftp2 start"
$ns at .010 "$ftp3 start"
#$ns at .1 "$cbr4 start"
